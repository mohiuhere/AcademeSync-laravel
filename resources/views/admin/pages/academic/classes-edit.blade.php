...
@section('page-heading', 'Class Edit')
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form action="{{ route('edit.classes') }}" method="post">
            @csrf
            <div class="row">
                <input type="hidden" name="id" value="{{ $data->id }}">
                <div class="col">
                    <label for="inputClassName" class="form-label">Name</label>
                    <input value="{{ $data->class_name }}" name="class_name" type="text" class="form-control" placeholder="Class Name" aria-label="Class Name">
                </div>
                <div class="col">
